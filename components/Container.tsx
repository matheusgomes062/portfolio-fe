  ...
  return (
    <div className="bg-gray-50 dark:bg-gray-900">
      <Head>
        ...
        <meta property="og:url" content={`https://mgodev.me${router.asPath}`} />
        <link rel="canonical" href={`https://mgodev.me${router.asPath}`} />
        <meta property="og:type" content={meta.type} />
        <meta property="og:site_name" content="Matheus Gomes" />
        <meta property="og:description" content={meta.description} />
        <meta property="og:title" content={meta.title} />
        <meta property="og:image" content={meta.image} />
        <meta name="twitter:card" content="summary_large_image" />
        <meta name="twitter:site" content="@matheusgomes062" />
